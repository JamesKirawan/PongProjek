...
public class GameManager : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        {
            // Ketika tombol restart ditekan skor kedua pemain...
            player1.ResetScore();
            player2.ResetScore();
        ...
        if (player1.Score == maxScore)
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 10, 200, 1000), "PLAYER ONE WINS");

            // ... dan kembalikan bola tengah.
        ...
        else if (player2.Score == maxScore)
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 + 30, Screen.height / 2 - 10, 200, 1000), "PLAYER TWO WINS");
        ...
        // Toggle nilai debug window & trajectory
